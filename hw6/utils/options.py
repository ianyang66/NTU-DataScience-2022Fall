...
parser.add_argument('--output_file', type = str, default = 'batch8_rotate7_adamw_epo10/train/output.csv', help = 'The directory where the summaries will be stored.') # 'experiments/'

parser.add_argument('--job_dir', type = str, default = 'batch8_rotate7_adamw_epo10/train/', help = 'The directory where the summaries will be stored.') # 'experiments/'
